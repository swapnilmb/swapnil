    ...
    1: [function (require, module, exports) {
            module.exports = {
                ...
                _createZoomIn: function (instance) {
                    ...
                    var zoomInBackground = document.createElementNS(instance.svgNS, 'rect');
                ...
                _createZoomReset: function (instance) {
                    ...
                    resetPanZoomControl.addEventListener('click', function () {
                        instance.getPublicInstance().resetZoom();
                    }, false);
                    resetPanZoomControl.addEventListener('touchstart', function () {
                        instance.getPublicInstance().resetZoom();
                    }, false);

                    var resetPanZoomControlBackground = document.createElementNS(instance.svgNS, 'rect');
                ...
                _createZoomOut: function (instance) {
                    ...
                    var zoomOutBackground = document.createElementNS(instance.svgNS, 'rect');
            ...
            if (!window.hasOwnProperty('addWheelListener')) {
                ...
                (function (window, document) {
                    ...
                    support = "onwheel" in document.createElement("div") ? "wheel" : document.onmousewheel !== undefined ? "mousewheel" : "DOMMouseScroll"; // let's assume that remaining browsers are older Firefox
            ...
            var Mousewheel = require('./mousewheel'), ControlIcons = require('./control-icons'), Utils = require('./utilities'), SvgUtils = require('./svg-utilities');
            ...
            */
            SvgPanZoom.prototype.processCTM = function () {
                ...
                if (this.options.fit) {
                    var newCTM = this.viewport.getCTM(), newScale = Math.min(this.width / (this._viewBox.width - this._viewBox.x), this.height / (this._viewBox.height - this._viewBox.y));
            ...
            */
            SvgPanZoom.prototype.setupHandlers = function () {
                ...
                window.onmousewheel(this.svg, function (evt) {
            ...
            */
            SvgPanZoom.prototype.handleMouseWheel = function (evt) {
                ...
                var svg = (evt.target.tagName === 'svg' || evt.target.tagName === 'SVG') ? evt.target : evt.target.ownerSVGElement || evt.target.correspondingElement.ownerSVGElement, relativeMousePoint = SvgUtils.getRelativeMousePoint(svg, evt), zoom = Math.pow(1 + this.options.zoomScaleSensitivity, (-1) * delta);
            ...
            */
            SvgPanZoom.prototype.zoomAtPoint = function (svg, point, zoomScale, zoomAbsolute) {
                ...
                var k = svg.createSVGMatrix().translate(point.x, point.y).scale(zoomScale).translate(-point.x, -point.y), wasZoom = viewportCTM, setZoom = viewportCTM.multiply(k);
            ...
            */
            SvgPanZoom.prototype.handleMouseMove = function (evt) {
                ...
                if (this.state === 'pan' && this.options.panEnabled) {
                    ...
                    // Pan mode
                    var point = SvgUtils.getEventPoint(evt).matrixTransform(this.stateTf), viewportCTM = this.stateTf.inverse().translate(point.x - this.stateOrigin.x, point.y - this.stateOrigin.y);
            ...
            */
            SvgPanZoom.prototype.handleDblClick = function (evt) {
                var target = evt.target, svg = (target.tagName === 'svg' || target.tagName === 'SVG') ? target : target.ownerSVGElement || target.correspondingElement.ownerSVGElement;
            ...
            */
            SvgPanZoom.prototype.center = function (dropCache) {
                ...
                var offsetX = (this.width - (this._viewBox.width + this._viewBox.x) * this.getZoom()) * 0.5, offsetY = (this.height - (this._viewBox.height + this._viewBox.y) * this.getZoom()) * 0.5;
                ...
                if (!this.publicInstance) {
                    this.publicInstance = {
                        ...
                        setBeforePan: function (fn) {
                            that.options.beforePan = Utils.proxy(fn, that.publicInstance);
                        },
                        setOnPan: function (fn) {
                            that.options.onPan = Utils.proxy(fn, that.publicInstance);
                        },
                        enableZoom: function () {
                        ...
                        setBeforeZoom: function (fn) {
                            that.options.beforeZoom = Utils.proxy(fn, that.publicInstance);
                        },
                        setOnZoom: function (fn) {
                            that.options.onZoom = Utils.proxy(fn, that.publicInstance);
                        },
                        zoom: function (scale) {
                        ...
                        fit: function (dropCache) {
                            return that.fit(dropCache);
                        },
                        center: function (dropCache) {
                            return that.center(dropCache);
                        },
                        resize: function () {
                            that.resize();
                        }
            ...
            */
            ...
            module.exports = {
                ...
                getEventPoint: function (evt) {
                    var svg = (evt.target.tagName === 'svg' || evt.target.tagName === 'SVG') ? evt.target : evt.target.ownerSVGElement || evt.target.correspondingElement.ownerSVGElement, point = svg.createSVGPoint();
                ...
                getSvgCenterPoint: function (svg) {
                    var boundingClientRect = this.getBoundingClientRectNormalized(svg), width = boundingClientRect.width, height = boundingClientRect.height, point = svg.createSVGPoint();
            ...
            module.exports = {
                ...
                */
                ...
                isElement: function (o) {
                    return (typeof HTMLElement === "object" ? (o instanceof HTMLElement || o instanceof SVGElement || o instanceof SVGSVGElement) : o && typeof o === "object" && o !== null && o.nodeType === 1 && typeof o.nodeName === "string");
                },
                isObject: function (o) {
...
//# sourceMappingURL=svg-pan-zooms.js.map
